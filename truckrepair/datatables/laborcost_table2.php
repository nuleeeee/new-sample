...
const tableLabor2 = new DataTable('#laborcost_datatable2', {
    ...
    columns: [
        ...
        },
        {
            ...
            defaultContent: '<label class=\"labor2_fileLabel\"><i class=\"bi bi-images pointer\" data-bs-toggle=\"tooltip\" data-bs-placement=\"bottom\" title=\"Upload Files\"/><input type=\"file\" name=\"labor2_fileInput\" id=\"labor2_fileInput_\" class=\"labor2_fileInput d-none\"></label>',
            orderable: false
        },
        {
            data: null,
