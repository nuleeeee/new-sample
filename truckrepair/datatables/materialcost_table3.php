...
const tableMaterial3 = new DataTable('#materialcost_datatable3', {
    ...
    columns: [
        ...
        },
        {
            ...
            defaultContent: '<label class=\"material3_fileLabel\"><i class=\"bi bi-images pointer\" data-bs-toggle=\"tooltip\" data-bs-placement=\"bottom\" title=\"Upload Files\"/><input type=\"file\" name=\"material3_fileInput\" id=\"material3_fileInput_\" class=\"material3_fileInput d-none\"></label>',
            orderable: false
        },
        {
            data: null,
